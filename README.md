...
The repository has:
* A command_line.py file for playing the game throughthe command line
* A gui.py file that was made using tkinter
* And files for a flask application for a website where you can play the game.
